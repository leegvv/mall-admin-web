...
<script>
    import {listAllCategory, createResourceCategory, updateResourceCategory, deleteResourceCategory} from '@/api/resourceCategory';
        ...
        methods: {
            ...
            handleDialogConfirm() {
                this.$confirm('是否要确认？', '提示', {
                    ...
                    if (this.isEdit) {
                        updateResourceCategory(this.resourceCategory.id, this.resourceCategory)
                            .then(() => {
                                this.$message({
                                    message: '修改成功',
                                    type: 'success'
                        ...
                        createResourceCategory(this.resourceCategory)
                            .then(() => {
                                this.$message({
                                    message: '添加成功！',
                                    type: 'success'
